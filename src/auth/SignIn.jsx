...
const SignIn= () => {
  ...
  const submitter = async value => {
    await Post({url: "auth/login", body: {...value, entityType: "employee"}})
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit(submitter)} className="flex flex-col gap-4">
                <CommonInput name="email" type="email" placeholder={"Enter your email"} control={control} label="Email"/>
                <CommonInput name="password" type="password" placeholder={"Password"} control={control} label="Password"/>
                {/* <div className="mb-4">
